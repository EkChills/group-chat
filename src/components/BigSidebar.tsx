...
console.log(queryResults[1]);
  ...
  return (
    <div className=' w-[20.25rem] hidden overflow-x-hidden lg:flex lg:flex-col bg-[#120F13] min-h-screen overflow-y-scroll p-4 scrollbar scrollbar-thumb-gray-900 scrollbar-none scrollbar-track-gray-100 items-start relative'>
      ...
      <div className='mt-[1.56rem] flex flex-col space-y-[2rem] max-h-[21rem] overflow-y-scroll w-[20.25rem] scrollbar-none scrollbar scrollbar-thumb-gray-900  scrollbar-track-gray-100'>
